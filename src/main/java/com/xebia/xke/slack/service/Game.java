...
public class Game {
	...
	public void start(Player player1, Player player2) {
		...
		board.getGrid()[nextMove[0]][nextMove[1]] = botPlayer.getEmoji()
				.getCode();
	}

	public String play(Coordinate move) {

		if (board.getGrid()[move.getX()][move.getY()]
				.equals(theme.getBlankEmoji())) {
			board.getGrid()[move.getX()][move.getY()] = player.getEmoji()
					.getCode();
			...
			int[] nextMove = ai.getNextMove();
			if (board.getGrid()[nextMove[0]][nextMove[1]]
					.equals(theme.getBlankEmoji())) {
				board.getGrid()[nextMove[0]][nextMove[1]] = botPlayer.getEmoji()
						.getCode();
	...
	private static int[] winningPatterns = {0b111000000, 0b000111000,
